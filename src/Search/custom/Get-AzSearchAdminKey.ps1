...
.Link
https://docs.microsoft.com/powershell/module/az.search/get-azsearchadminkey
#>
function Get-AzSearchAdminKey {
[Microsoft.Azure.PowerShell.Cmdlets.Search.ExternalDocs("https://beztest.com", "beztest")]
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Search.Models.Api20150228.IAdminKeyResult])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.Search.private\Get-AzSearchAdminKey_List';
        }
