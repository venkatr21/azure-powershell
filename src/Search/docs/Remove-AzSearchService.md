...
### Delete (Default)
```
Remove-AzSearchService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSearchService -InputObject <ISearchIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
